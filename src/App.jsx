    ...
    <div className="min-h-screen">
            ...
            {[
              {
                step: '1',
                title: '选场景',
                desc: '写总结？写情况说明？写信贷报告？一键选择你要的场景',
                icon: '📋',
              },
              {
                step: '2',
                title: '填要点',
                desc: '按提示填入关键信息：数据、要点、行名……不用写提示词',
                icon: '✏️',
              },
              {
                step: '3',
                title: '一键出底稿',
                desc: '3秒生成银行味材料，术语精准、格式规范，复制就能交',
                icon: '✅',
              },
            ].map((item) => (
      ...
      <section className="py-16 md:py-24 bg-gradient-to-br from-bank-600 to-bank-800 text-white">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <p className="text-xl text-bank-100 mb-2">
            无隐藏费用 · 无订阅 · 无后续扣款
          </p>
          <p className="text-bank-200 mb-8">
            3个核心场景全开放 · 永久使用 · 后续场景包免费更新
          </p>
          ...
          <p className="text-bank-200 text-sm mt-4">
            早鸟价 ¥49 · 恢复原价 ¥99
          </p>
        </div>
      </section>
              ...
              <div className="text-center py-6">
                ...
                <button
                  onClick={() => {
                    setShowModal(false)
                    setSubmitted(false)
                    setFormData({ name: '', wechat: '', position: '' })
                  }}
                  className="mt-6 text-bank-600 font-medium hover:text-bank-700 transition-colors"
                >
                  关闭
                </button>
              </div>
